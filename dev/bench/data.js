    ...
    "Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "6010058c632db47c56a74487a5e530e6abd1c54b",
          "message": "chore: bump version to 4.3.3",
          "timestamp": "2026-07-24T12:39:55-04:00",
          "tree_id": "c08f5dab3701b4791ea6aa8dcad078192bc107a1",
          "url": "https://github.com/dangel34/PQ-File-Encryption/commit/6010058c632db47c56a74487a5e530e6abd1c54b"
        },
        "date": 1784911464769,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "3ec7b48def2cad9e8e0e62d5e05fbd4116b59010",
          "message": "chore(deps): update dependency versions in Cargo.lock and config.toml\n\nBumped versions for several dependencies in Cargo.lock, including `aes` (0.9.2), `cc` (1.4.0), `either` (1.17.0), `event-listener` (5.4.2), `jiff` (0.2.35), and `jiff-static` (0.2.35). Updated the corresponding version in supply-chain/config.toml to reflect these changes. Additionally, updated the `pqfile` version in pqfile-python/Cargo.lock from 4.3.2 to 4.3.3. This ensures compatibility with the latest features and security improvements.",
          "timestamp": "2026-07-27T09:44:16-04:00",
          "tree_id": "cd4c470cd9fa3262fd8276d16b792186984ccefc",
          "url": "https://github.com/dangel34/PQ-File-Encryption/commit/3ec7b48def2cad9e8e0e62d5e05fbd4116b59010"
        },
        "date": 1785160088014,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "6aa46cf6cf4dd712475c73731d7a16cb78dd4ceb",
          "message": "chore: update pqfile version to 4.3.4 in all Cargo.lock files",
          "timestamp": "2026-08-30T15:07:19-04:00",
          "tree_id": "d9dc965e973afcff280d602022f6661146b5543d",
          "url": "https://github.com/dangel34/PQ-File-Encryption/commit/6aa46cf6cf4dd712475c73731d7a16cb78dd4ceb"
        },
        "date": 1788117050577,
        "tool": "cargo",
        "benches": [
