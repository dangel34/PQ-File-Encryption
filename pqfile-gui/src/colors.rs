...
pub(crate) fn c_chrome(d: bool)   -> Color32 { if d { D_MANTLE }   else { L_MANTLE } }
pub(crate) fn c_card(d: bool)     -> Color32 { if d { D_MANTLE }   else { L_MANTLE } }
pub(crate) fn c_surface0(d: bool) -> Color32 { if d { D_SURFACE0 } else { L_SURFACE0 } }
pub(crate) fn c_surface1(d: bool) -> Color32 { if d { D_SURFACE1 } else { L_SURFACE1 } }
pub(crate) fn c_overlay(d: bool)  -> Color32 { if d { D_OVERLAY }  else { L_OVERLAY } }
pub(crate) fn c_subtext(d: bool)  -> Color32 { if d { D_SUBTEXT }  else { L_SUBTEXT } }
pub(crate) fn c_text(d: bool)     -> Color32 { if d { D_TEXT }     else { L_TEXT } }
pub(crate) fn c_accent(d: bool)   -> Color32 { if d { D_ACCENT }   else { L_ACCENT } }
pub(crate) fn c_green(d: bool)    -> Color32 { if d { D_GREEN }    else { L_GREEN } }
pub(crate) fn c_red(d: bool)      -> Color32 { if d { D_RED }      else { L_RED } }
